            ...
            <template v-slot:content>
                <div class="" :class="{'mt-10': windowHeight>800, 'mt-3': windowHeight<800}">
                    <v-row justify="start">
                        ...
                        <v-col cols="9">
                            <div class="border-box-quiz nimate__animated animate__backInLeft" :class="{'mt-5': windowHeight > 800, 'mt-3': windowHeight < 800 }" v-if="boxText">
                    ...
                    <v-row no-gutters class="mt-4 animate__animated animate__backInLeft">
                        <v-col cols="4">
                            <v-img src="@/assets/evolucion/car1.png" contain :max-height="windowHeight > 800 ? '240' : '190'"></v-img>
                        </v-col>
                        <v-col cols="4" class="d-flex justify-space-between ">
                            <hr class="line-vertical">
                            <v-img src="@/assets/evolucion/car2.png" contain :max-height="windowHeight > 800 ? '240' : '190'"></v-img>
                            <hr class="line-vertical">
                        </v-col>
                        <v-col cols="4">
                            <v-img src="@/assets/evolucion/car3.png" contain :max-height="windowHeight > 800 ? '240' : '190'"></v-img>
                        </v-col>

                        <v-col cols="4">
                            <v-img src="@/assets/evolucion/division.png" max-width="850"></v-img>
                            <div class="text-center bg-gray-1 size-box mx-1">
                                <span class="font-weight-normal text-white" :class="{'font-size-34': windowHeight>800, 'font-size-26':windowHeight<800}">1885</span>
                                <p class="font-weight-normal text-white mx-2" :class="{'font-size-22': windowHeight>800, 'font-size-19': windowHeight<800}">Benz motorwagen. Primer automóvil a gasolina.</p>
                            </div>
                        </v-col>
                        <v-col cols="4">
                            <v-img src="@/assets/evolucion/division.png" max-width="850"></v-img>
                            <div class="text-center bg-gray-2 size-box mx-1">
                                <span class="font-weight-normal text-white" :class="{'font-size-34': windowHeight>800, 'font-size-26':windowHeight<800}">1895</span>
                                <p class="font-weight-normal text-white" :class="{'font-size-22': windowHeight>800, 'font-size-19': windowHeight<800}">Thomas Parker. Auto eléctrico.</p>
                            </div>
                        </v-col>
                        <v-col cols="4">
                            <v-img src="@/assets/evolucion/division.png" max-width="850"></v-img>
                            <div class="text-center bg-gray-3 size-box mx-1">
                                <span class="font-weight-normal text-white" :class="{'font-size-34': windowHeight>800, 'font-size-26':windowHeight<800}">1898</span>
                                <p class="font-weight-normal text-white" :class="{'font-size-22': windowHeight>800, 'font-size-19': windowHeight<800}">Ferdinand Porsche. Auto híbrido eléctrico-gasolina</p>
                            </div>
                        </v-col>
                    </v-row>
                </div>
