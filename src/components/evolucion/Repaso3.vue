        ...
        <content-template subtitle="<p class='mt-5 font-weight-bold'>REPASO</p>">
            <template v-slot:content>
                <div class="" :class="{'mt-10': windowHeight>800, 'mt-3': windowHeight<800}">
                    ...
                    <v-row class="mx-16" justify="center" :class="{'mt-10': windowHeight>800, 'mt-0': windowHeight<800}">
                    ...
                    <v-row justify="center" :class="{'mt-15': windowHeight>800, 'mt-0': windowHeight<800}">
                        <v-col cols="2">
