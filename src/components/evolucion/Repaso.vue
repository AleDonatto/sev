        ...
        <content-template subtitle="<p class='mt-5 font-weight-bold'>REPASO</p>">
            <template v-slot:content>
                <div class="" :class="{'mt-10': windowHeight>800, 'mt-3': windowHeight<800}">
                    ...
                    <v-row :class="{'mt-7':windowHeight>800, 'mt-4': windowHeight<800}" justify="center">
                        <!--<v-col cols="4" align-self="center">
                            <v-row no-gutters>
                                <v-col cols="2">
                                    <v-img src="@/assets/evolucion/1.png" contain max-height="80" class="mt-6" :class="{'mt-6':windowHeight>800, 'mt-0':windowHeight<800}"></v-img>
                                </v-col>
                                <v-col cols="10">
                                    ...
                                    :class="{
                                        ...
                                        'size-box-drop-sm':windowHeight<800
                                    }">
