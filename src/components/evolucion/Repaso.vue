            ...
            <template v-slot:content>
                <div class="" :class="{'mt-10': windowHeight>800, 'mt-3': windowHeight<780}">
                    <v-row justify="start">
                        ...
                        <v-col cols="9">
                            <div class="border-box-evolution" :class="{'mt-10': windowHeight > 800, 'mt-3': windowHeight < 780 }" v-if="boxText">
                                <p class="py-4 px-3">
                    ...
                    <v-row justify="center" :class="{'mt-15': windowHeight > 800, 'mt-1' : windowHeight < 780}">
                        <v-col cols="3">
                    ...
                    <v-row :class="{'mt-7':windowHeight>800, 'mt-4': windowHeight<780}" justify="center">
                        <!--<v-col cols="4" align-self="center">
                            <v-row no-gutters>
                                <v-col cols="2">
                                    <v-img src="@/assets/evolucion/1.png" contain max-height="80" class="mt-6" :class="{'mt-6':windowHeight>800, 'mt-0':windowHeight<780}"></v-img>
                                </v-col>
                                <v-col cols="10">
                                    ...
                                    :class="{
                                        ...
                                        'size-box-drop-lg': windowHeight>800, 
                    ...
                    <v-row justify="center" :class="{'mt-15':windowHeight > 800, 'mt-4': windowHeight < 780}">
