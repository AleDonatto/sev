            ...
            <template v-slot:content>
                <div class="" :class="{'mt-10': windowHeight>800, 'mt-3': windowHeight<800}">
                    <v-row justify="start">
                        ...
                        <v-col cols="9">
                            <div class="border-box-instructions py-6 px-4" :class="{'mt-10': windowHeight>800, 'mt-2': windowHeight<800}" v-if="boxText">
                                <p class="" :class="{'font-size-24':windowHeight>800, 'font-size-19': windowHeight<800}">Acomoda de mayor a menor generación de emisiones contaminantes las siguentes tecnologías</p>
                            </div>
                        </v-col>
                    </v-row>

                    <v-row class="mx-16" :class="{'mt-10': windowHeight>800, 'mt-0': windowHeight<800}" justify="center" v-if="answeredQuiz2 === false">
                        <v-col cols="5">
                            <v-row>
                                <v-col cols="12" :class="{'margin-top-md':windowHeight<800}">
                                    <div class="d-flex">
                        ...
                        <v-col cols="5" align-self="center">
                            <v-row>
                                ...
                                <v-col cols="12" align-self="center" :class="{'mt-0':windowHeight<800}">
                    ...
                    <v-row justify="center" :class="{'mt-7': windowHeight>800, 'mt-0': windowHeight<800}">
                        <v-col cols="2">
