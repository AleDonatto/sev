            ...
            <template v-slot:content>
                <div class="" :class="{'mt-10': windowHeight>900, 'mt-3': windowHeight<750}">
                    <v-row justify="start">
                        ...
                        <v-col cols="9">
                            <div class="border-box-instructions py-6 px-4" :class="{'mt-10': windowHeight>900, 'mt-2': windowHeight<750}" v-if="boxText">
                                <p class="" :class="{'font-size-24':windowHeight>900, 'font-size-19': windowHeight<750}">Acomoda de mayor a menor generación de emisiones contaminantes las siguentes tecnologías</p>
                            </div>
                        </v-col>
                    </v-row>

                    <v-row class="mx-16" :class="{'mt-10': windowHeight>900, 'mt-0': windowHeight<750}" justify="center" v-if="answeredQuiz2 === false">
                        <v-col cols="5">
                            <v-row>
                                <v-col cols="12" :class="{'margin-top-md':windowHeight<750}">
                                    <div class="d-flex">
                            ...
                            <v-row>
                                <v-col cols="12" :class="{'margin-top-md':windowHeight<750}">
                                    <div class="box-zone-drag size-zone-drop text-center" @dragstart="drag" draggable="true" v-if="answers.a5 !== true">
                                        <p class="pa-2" id="electronicos">Eléctricos</p>
                                    </div>
                                </v-col>
                                <v-col cols="12" align-self="center" :class="{'mt-0':windowHeight<750}">
                    ...
                    <v-row justify="center" :class="{'mt-15': windowHeight>900, 'mt-0': windowHeight<750}">
                        <v-col cols="2">
