<template>
    <div>
        <content-template 
        :title="count === 1 ? 'Motor a combustión interna (ICE)' : count === 2 ? 'Semihíbridos (MHEV)': 
        count === 3 ? 'Motor híbrido fuerte Full (HEV)': count === 4 ? 'Motor híbrido enchufable (PHEV)': 
        ...
        subtitle="Tipos de tren <br/> motriz más comúnes">
            <template v-slot:content>
                <div class="" :class="{'mt-10': windowHeight>800, 'mt-3': windowHeight<800}">
                    ...
                    <v-row justify="center" class="mx-5 animate__animated animate__backInLeft" :class="{'mt-4': windowHeight>800, 'mt-0': windowHeight<800}" v-if="count === 0">
                        <v-col cols="3">
                    ...
                    <v-row justify="center" class="bg-gradient mx-5 animate__animated animate__backInRight" v-if="count === 0">
                        <v-col cols="3" align="center">
                            <p class="font-weight-bold " :class="{'font-size-30': windowHeight>800, 'font-size-20': windowHeight<800}">Altas</p>
                        </v-col>
                        <v-col cols="3" align="center">
                            <p class="font-weight-bold " :class="{'font-size-30': windowHeight>800, 'font-size-20': windowHeight<800}">Medias/bajas</p>
                        </v-col>
                        <v-col cols="6" align="center">
                            <p class="font-weight-bold " :class="{'font-size-30': windowHeight>800, 'font-size-20': windowHeight<800}">Cero emisiones</p>
                        </v-col>
                    </v-row>
...
export default {
    ...
    computed: {
        ...mapState(['canNext', 'windowHeight', 'windowSize', 'count','countShowImage','boxText','soundOn']),
        checkAudios: function () {
            if(this.count === 1){
                return this.playAudioStepICE()
            }
        }
    },
    mounted(){
    ...
    methods: {
        playAudio(){
            if(this.soundOn === true){
                ...
                window.audio.src = require('@/assets/audios/evolucion/SEV-evolucion-5.mp3')
                window.audio.play()
                setTimeout(()=> {
