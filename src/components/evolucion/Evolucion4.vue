                    ...
                    <v-row no-gutters class="animate__animated animate__backInRight">
                        <v-col cols="12" align-self="center">
                            <div class="text-center bg-gray">
                                <span class=" font-size-48 text-white" :class="{'font-size-48': windowHeight>800, 'font-size-30': windowHeight<780}">Autos eléctricos (BEV) y otras tecnologías 0 emisiones</span>
                            </div>
                        </v-col>
                    </v-row>
                </div>
