    ...
    <div>
        <main-template>
            <template v-slot:content>
                <v-row justify="start" class="" :class="{'bg-gracias mt-2': windowHeight> 900, 'bg-gracias-md': windowHeight<750}">
                    <v-row justify="start" no-gutters class="" :class="{'mt-10': windowHeight>900, 'mt-3': windowHeight<750}">
                        <v-col cols="4">
                    ...
                    <v-row justify="start" no-gutters class="mt-0">
                        <v-col cols="5">
                            <p class=" white--text px-10" :class="{'font-size-26':windowHeight>900, 'font-size-22': windowHeight<750}">
                                ...
                                <br>
                                <span class="font-weight-bold">Cierra esta venta para que tus respuestas sean enviadas.</span>
                            </p>

                            <!--<v-btn type="button" class="ml-10" rounded color="#FDBE2E" @click="closeWindow">
                                <span class=" font-size-30 font-weight-semibold" :class="{'font-size-30': windowHeight > 900, 'font-size-24': windowHeight < 750}">Click para Finalizar</span>
                            </v-btn>-->
                        </v-col>
                    </v-row>
                </v-row>
