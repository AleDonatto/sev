                ...
                <div class="" :class="{'mt-10': windowHeight>800, 'mt-3': windowHeight<800}">
                            ...
                            <div class="border-box-quiz nimate__animated animate__backInLeft pa-1" :class="{'mt-5': windowHeight > 800, 'mt-3': windowHeight < 800 }" v-if="boxText">
                                <v-card :height="windowHeight > 800 ? 130 : 110" class="overflow-auto rounded-lg ma-1">
                                    <v-card-text :class="{'font-size-22': windowHeight>800, 'font-size-20': windowHeight<800}">
                                        Los cargadores Nivel 1 son los cargadores portátiles que se suelen proporcionar a los compradores 
                                        ...
                                        <br><br>
                                        Los cargadores Nivel 2, también conocidos como Wallbox, trabajan a mayor voltaje y amperaje y, 
                                        ...
                                        <br><br>
                                        Los cargadores Nivel 3, también llamados cargadores rápidos o supercargadores, trabajan con 
                                        ...
                                        se necesite un tiempo de carga muy rápido. De lo contrario, es mejor utilizar un cargador Nivel 2.
                                    </v-card-text>
                                </v-card>
                            </div>
                        </v-col>
                    ...
                    <v-row justify="center" class="h-100 mx-10 px-5 py-1 rounded-xl bg-boxstep-content" v-if="countModos >= 1">
                        ...
                        <!--<v-col cols="3" class="animate__animated animate__backInUp" v-if="countModos >= 4">
                            <v-card class="rounded-lg" :height="windowHeight>800 ? '550': '330'" :width="windowHeight>800 ? '280': '190'">
                                <v-img src="@/assets/cargando/modo4.png" :height="windowHeight > 800 ? '540': windowHeight<660 ? '320': '320'" contain></v-img>
                            </v-card>
                        </v-col>-->
                    </v-row>
                </div>
