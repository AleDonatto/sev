    ...
    <div>
        <content-template subtitle="<p class='mt-6'>Tipos de cargadores</p>">
            <template v-slot:content>
                <div class="" :class="{'mt-4': windowHeight>800, 'mt-3': windowHeight<780}">
                    ...
                    <v-row justify="start" class="mx-10 px-5 py-5 rounded-xl bg-boxstep-content mt-0">
                        <v-col cols="3" align-self="center" align="end" class="animate__animated animate__backInLeft">
                            <p class="font-weight-bold  text-right" :class="{'font-size-22': windowHeight>800, 'font-size-20': windowHeight<780}">
                                No todos los
                            </p>
                            <p class="font-weight-bold  text-right" :class="{'font-size-22': windowHeight>800, 'font-size-20': windowHeight<780}">
                                conectores son
                            </p>
                            <p class=" text-right" :class="{'font-size-22': windowHeight>800, 'font-size-20': windowHeight<780}">
                                <span class="font-weight-bold">Iguales,</span> hay que
                            </p>
                            <p class="font-weight-bold  text-right text-yellow-p" :class="{'font-size-22': windowHeight>800, 'font-size-20': windowHeight<780}">
                                escoger el adecuado
                            </p>
                            <p class=" text-right" :class="{'font-size-22': windowHeight>800, 'font-size-20': windowHeight<780}">
                                pára cada vehiculos
