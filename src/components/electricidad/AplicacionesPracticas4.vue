                ...
                <div class="" :class="{'mt-10': windowHeight>900, 'mt-3': windowHeight<750}">
                    ...
                    <v-row justify="center" class="rounded-xl bg-color mx-10 px-5 py-5">
                        <v-col cols="12" class="animate__animated animate__backInLeft">
                            <p class="" :class="{'font-size-24': windowHeight>900, 'font-size-19': windowHeight<750}">
                            ...
                            <p class="" :class="{'font-size-24': windowHeight>900, 'font-size-10': windowHeight<750}">Existen diferentes homologaciones.</p>
                            <ul class=" pl-5" :class="{'mt-5 font-size-24': windowHeight>900, 'mt-2 font-size-19': windowHeight<750}">
                                <li>
