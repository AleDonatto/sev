                ...
                <div class="" :class="{'mt-10': windowHeight>800, 'mt-3': windowHeight<780}" >
                        ...
                        <v-col cols="9">
                            <div class="border-box-quiz nimate__animated animate__backInLeft pa-1" :class="{'mt-5': windowHeight > 800, 'mt-3': windowHeight < 780 }" v-if="boxText">
                                <v-card :height="windowHeight > 800 ? 130 : 110" class="overflow-auto rounded-lg ma-1">
                                    <v-card-text :class="{'font-size-22': windowHeight>800, 'font-size-20': windowHeight<780}" v-if="count === 0">
                    ...
                    <v-row justify="center" class="rounded-xl bg-color mx-10 px-5" v-if="counterStep === 0">
                        <v-col cols="12" align="start" class="animate__animated animate__backInDown">
                            <p class="" :class="{'font-size-30': windowHeight>800, 'font-size-22': windowHeight<780}">El costo de carga de una bateria dependerá de: </p>
                        </v-col>
                        ...
                        <v-col cols="12" class="animate__animated animate__backInLeft">
                            <p class="" :class="{'font-size-30':windowHeight>800, 'font-size-22': windowHeight<780}">¿Cuanto cuesta cargar 20% hasta 100% de la bateria de un SEV E-WAN Bold (29.4 kWh)?</p>
                        </v-col>

                        <v-col cols="9" class="animate__animated animate__backInLeft">
                            <p class="" :class="{'font-size-24':windowHeight>800, 'font-size-20': windowHeight<780}">Consumo básico: $0.859/kWh 🡪 23.5 X 0.859 = $20.18.</p>
                            <p class="" :class="{'font-size-24':windowHeight>800, 'font-size-20': windowHeight<780}">Consumo excedente: $3.042/kWh 🡪 23.5 X 3.042 = $71.48.</p>
                        </v-col>
                    </v-row>
                    ...
                    <v-row no-gutters justify="center" class="rounded-xl bg-color mx-10 px-5 mt-3" v-if="counterStep === 1">
                        ...
                        <v-col cols="12" class="mt-3">
                            <p class="" :class="{'font-size-30': windowHeight>800, 'font-size-22': windowHeight<780}">Ejercicio: ¿Cuánto cuesta cargar de 20% hasta 100% la batería de un vehículo eléctrico que cuenta con una batería de 50 kWh?</p>
                        </v-col>
                        <v-col cols="10">
                            <p class="" :class="{'font-size-30': windowSize>800, 'font-size-20': windowHeight<780}">Tarifa CFE en consumo básico: $0.859/kWh 🡪 40 kWh X $0.859/kWh = $34.36</p>
                            <p class="" :class="{'font-size-30': windowSize>800, 'font-size-20': windowHeight<780}">Tarifa CFE en consumo excedente: $3.042/kWh 🡪 40 kWh X $3.042/kWh = $121.68</p>
                        </v-col>
