                ...
                <div class="" :class="{'mt-10': windowHeight>800, 'mt-3': windowHeight<800}">
                    ...
                    <v-row justify="center" class="mx-10 bg-color rounded-xl">
                        <v-col cols="12" class="animate__animated animate__backInLeft">
                            <p class="" :class="{'font-size-30': windowHeight>800, 'font-size-20': windowHeight<800}">¿Y qué pasa si tengo panales fotovoltaícos?</p>
                        </v-col>
                        <v-col cols="1" align="center" class="animate__animated animate__backInLeft">
                            <p class="vertical-text  font-weight-bold"  :class="{'font-size-30': windowHeight>800, 'font-size-20': windowHeight<800}">Consumo Historico</p>
                        </v-col>
