                ...
                <div class="" :class="{'mt-10': windowHeight>900, 'mt-3': windowHeight<700}">
                    ...
                    <v-row justify="center" class="mx-10 bg-color rounded-xl">
                        <v-col cols="12" class="animate__animated animate__backInLeft">
                            <p class="" :class="{'font-size-30': windowHeight>900, 'font-size-22': windowHeight<700}">¿Y qué pasa si tengo panales fotovoltaícos?</p>
                        </v-col>
                        <v-col cols="1" align="center" class="animate__animated animate__backInLeft">
                            <p class="vertical-text  font-weight-bold"  :class="{'font-size-30': windowHeight>900, 'font-size-22': windowHeight<700}">Consumo Historico</p>
                        </v-col>
