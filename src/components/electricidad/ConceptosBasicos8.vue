                ...
                <div class="" :class="{'mt-10': windowHeight>900, 'mt-3': windowHeight<750}">
                    ...
                    <v-row justify="center" class="mx-10 rounded-xl bg-color">
                        ...
                        <v-col cols="5" align="center" class="animate__animated animate__backInLeft">
                            ...
                            <p class="font-weight-bold mt-2" :class="{'font-size-22': windowHeight>900, 'font-size-19': windowHeight<750}">5 Volts, <br> 1 Amper <br> 5 Watts</p>
                        </v-col>
                        ...
                        <v-col cols="5" align="center" class="animate__animated animate__backInRight">
                            ...
                            <p class="font-weight-bold mt-2" :class="{'font-size-22': windowHeight>900, 'font-size-19': windowHeight<750}">5 Volts, <br> 2.1 Amper <br> 10.2 Watts</p>
                        </v-col>
                    </v-row>
