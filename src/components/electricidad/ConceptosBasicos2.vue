        ...
        <content-template title="ELECTRICIDAD" subtitle="<p class='mt-6'>Conceptos Básicos</p>">
            <template v-slot:content>
                <div class="" :class="{'mt-10': windowHeight>900, 'mt-3': windowHeight<750}">
                    ...
                    <v-row justify="center" class="rounded-xl bg-color mx-10" :class="{'mt-10':windowHeight>900, 'mt-0':windowHeight<750}">
                        <v-col cols="12" class="animate__animated animate__backInDown">
                            <p class="text-center " :class="{'font-size-36':windowHeight>900, 'font-size-26':windowHeight<750}">
                        ...
                        <v-col cols="5" align="center" class="animate__animated animate__backInLeft">
                            <p class="font-weight-bold " :class="{'font-size-36':windowHeight>900, 'font-size-26':windowHeight<750}">Corriente Directa</p>
                        ...
                        <v-col cols="5" class="animate__animated animate__backInRight">
                            <p class="font-weight-bold  text-center" :class="{'font-size-36':windowHeight>900, 'font-size-26':windowHeight<750}">Corriente Alterna</p>
                            <v-row justify="center">
                                <v-col cols="12">
                                    <v-img src="@/assets/electricidad/contacto.png" contain :max-height="windowHeight >900 ? '220': '150'" ></v-img>
                                    <v-row justify="center" :class="{'mx-10':windowHeight>900, 'mx-2': windowHeight<750}">
