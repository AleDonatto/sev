                ...
                <div class="" :class="{'mt-10': windowHeight>800, 'mt-3': windowHeight<800}">
                    ...
                    <v-row justify="center" class="rounded-xl bg-color mx-10">
                        <v-col cols="12" align="center" class="animate__animated animate__backInDown">
                            <p class="" :class="{'font-size-30':windowHeight>800, 'font-size-24':windowHeight<800}"><span class="font-weight-bold">Amper:</span> unidad de medición de la intensidad de la corriente eléctrica</p>
                        </v-col>
                        ...
                        <v-col cols="5" align="center" class="animate__animated animate__backInLeft mt-5">
                            ...
                            <p class="font-weight-bold mt-5" :class="{'font-size-30':windowHeight>800, 'font-size-24':windowHeight<800}">5 Volts, 1 Amper </p>
                        </v-col>
                        <v-col cols="1">
                        ...
                        <v-col cols="5" class="mt-5 animate__animated animate__backInRight">
                            ...
                            <p class="font-weight-bold text-center mt-5" :class="{'font-size-30':windowHeight>800, 'font-size-24':windowHeight<800}">5 Volts, 2.1 Amper</p>
                        </v-col>
